  ...
  return (
    <>
      <article className="article article_home">
        ...
        <p>
          Un menhir est comme une antenne, il sert à capter l{"'"}énergie du
          lieu et à la faire rayonner autour de lui. Il crée une alchimie entre
          Terre et Ciel (tellurique-cosmique). Poser un menhir permet de
          dynamiser les terrains perturbés et de repousser des réseaux négatifs.
        </p>
        <p>

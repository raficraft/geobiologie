...
export default function TransContent() {
  return (
    <article className="article article_home">
      ...
      <section>
        <h2>Découvrez l&rsquo;analyse transgénérationnelle de David Michel</h2>
        <h3>Qu&rsquo;est-ce que l&rsquo;analyse transgénérationnelle ?</h3>
        <p>
          L&rsquo;analyse transgénérationnelle est une méthode thérapeutique qui
          s&rsquo;apparente aux constellations familiales. Cette approche
          familiale transgénérationnelle se base sur l&rsquo;idée que nous
          ...
          des guerres, des blessures, des fausses couches, et d&rsquo;autres
          événements marquants dans l&rsquo;histoire familiale.
        </p>
      </section>

      <section>
        <h2>Les principes de l&rsquo;analyse transgénérationnelle</h2>
        <p>
          L&rsquo;analyse transgénérationnelle repose sur l&rsquo;exploration de
          l&rsquo;arbre généalogique pour identifier et comprendre les traumas
          hérités. En d&rsquo;autres termes, un thérapeute transgénérationnel
      ...
      <section>
        ...
        <p>
          ...
          et de les comprendre pour s&rsquo;en libérer.
        </p>
      </section>

      <section>
        <h2>
          Comment se déroule une séance d&rsquo;analyse transgénérationnelle ?
        </h2>
        <p>
          Lors d&rsquo;une séance d&rsquo;analyse transgénérationnelle, nous
      ...
      <section>
        ...
        <ul>
          <li>
            ...
            <p>
              Avec [X] années d&rsquo;expérience dans le domaine de la thérapie
          ...
          <li>
            ...
            <p>
              ...
              permettre d&rsquo;explorer votre histoire familiale en toute
              confiance.
            </p>
          </li>
        </ul>
      ...
      <section>
        ...
        <p>
          ...
          fardeaux ancestraux, n&rsquo;hésitez pas à nous contacter pour une
